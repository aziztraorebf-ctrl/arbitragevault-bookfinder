...
export interface ProductScore {
  ...
  // Textbook UX Simplification - Buying Guidance
  // Clear buy/sell recommendations with user-friendly labels
  buying_guidance?: BuyingGuidance
}

/**
 * BuyingGuidance - Clear buy/sell recommendations
 * Generated by buying_guidance_service.py
 */
export interface BuyingGuidance {
  /** Prix maximum a payer pour garantir le ROI cible */
  max_buy_price: number
  /** Prix de vente cible (median historique) */
  target_sell_price: number
  /** Profit net estime apres frais */
  estimated_profit: number
  /** ROI en pourcentage (0.50 = 50%) */
  estimated_roi_pct: number
  /** Fourchette de prix formatee (ex: "$45 - $58") */
  price_range: string
  /** Estimation du delai de vente en jours */
  estimated_days_to_sell: number
  /** Recommendation: BUY, HOLD, ou SKIP */
  recommendation: 'BUY' | 'HOLD' | 'SKIP'
  /** Explication de la recommendation en francais */
  recommendation_reason: string
  /** Label de confiance: Fiable, Modere, Incertain, Donnees insuffisantes */
  confidence_label: string
  /** Explications pour tooltips */
